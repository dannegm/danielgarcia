			...
			<div class="col-lg-12">
				<div class="block block-bordered">
					...
					<div class="block-content">
						{{Form::open(array(
							'route' => array('appanel.notes.update', $note->uid),
							'method' => 'PUT',
								...
								<div class="col-md-8 col-sm-9 col-sx-12">
									...
									<div class="form-group">
										<div class="col-sm-12">
											<div class="form-material">
												...
												<input class="form-control input-lg" type="text" id="title" name="title" placeholder="Título de la nota" value="{{$note->title}}">
											</div>
										</div>
									</div>
									<div class="form-group">
										<div class="col-sm-12">
											<div id="permalink-preview">
												...
												<span class="text-op">{{URL::asset('/note')}}/<b>{{$note->permalink}}</b></span>
											...
											<div id="permalink-form" style="display: none;">
												...
												<div class="input-group push-10-t">
													...
													<input class="form-control input-sm" style="font-weight: bold; font-size: 12px;" type="text" id="permalink" name="permalink" placeholder="permalink" value="{{$note->permalink}}">
												</div>
									...
									<div class="form-group">
										<div class="col-sm-12">
											...
											<textarea id="description" name="description" placeholder="Descripción">{{$note->description}}</textarea>
										</div>
									</div>
									...
									<div class="form-group" style="border-top: 1px solid #eee; border-bottom: 1px solid #eee; margin: 20px 0; padding-top: 20px">
										...
										<input type="hidden" id="pic_cover" name="pic_cover" value="{{$note->cover_uid}}" />
										...
										<div class="col-sm-12">
											<div class="form-material">
												...
												<div class="input-group">
													<input class="form-control" type="text" id="youtube_id" name="youtube_id" placeholder="URL de youtube" value="{{ $note->youtube_id != '' ? 'https://www.youtube.com/watch?v=' . $note->youtube_id : ''}}">
									...
									<div class="form-group">
										<div class="col-sm-12">
											...
											<textarea id="content" name="content" placeholder="Once upon a time...">{{$note->content}}</textarea>
										</div>
									</div>
								</div>
								<div class="col-md-4 col-sm-3 col-sx-12">
										...
										<div class="col-xs-12">
	                                        ...
	                                        <select class="js-select2 form-control" id="category_uid" name="category_uid" style="width: 100%;" data-placeholder="Seleciona una...">
	                                            ...
	                                            @foreach($categories as $c)
													<option value="{{$c->uid}}"{{$note->category_uid == $c->uid ? ' selected' : ''}}>{{$c->name}}</option>
												@endforeach
									...
									<div class="form-group">
										<div class="col-xs-12">
											...
											<input class="js-tags-input form-control" type="text" id="tags" name="tags" placeholder="Añadir tags..." value="{{$note->tags}}">
										</div>
									</div>
									<div class="form-group">
										<div class="col-xs-12">
	                                        ...
	                                        <div class="js-datetimepicker input-group date" data-show-today-button="true" data-show-clear="true" data-show-close="true" data-side-by-side="true">
	                                            <input class="form-control" type="text" id="posted_at" name="posted_at" placeholder="Seleciona fecha y hora..." value="{{$note->publisFormDate()}}">
	                                            <span class="input-group-addon">
										...
										<div class="col-xs-6">
	                                        ...
	                                        <div class="col-xs-12">
	                                            <label class="css-input switch switch-sm switch-warning">
	                                                <input id="marker" name="marker" type="checkbox"{{$note->marker == 1 ? ' checked' : ''}}><span></span> Destacado
	                                            </label>
	                                        </div>
	                                        <div class="col-xs-12">
	                                            <label class="css-input switch switch-sm switch-default">
	                                                <input id="draft" name="draft" type="checkbox"{{$note->draft == 1 ? ' checked' : ''}}><span></span> Borrador
	                                            </label>
	                                        </div>
									...
									<div class="form-group">
										<div class="col-xs-12">
											<a class="btn btn-danger trahs-note" href="{{route('appanel.notes.destroy', array('id' => $note->uid))}}">Eliminar nota</a>
										</div>
									</div>
								</div>
							</div>
