			...
			<div class="col-lg-12">
				<div class="block block-bordered">
					...
					<div class="block-content">
						{{Form::open(array(
							'url' => route('appanel.advertises.store'),
									...
									<div class="form-group">
										<div class="col-sm-12">
											<div class="form-material">
												...
												<input class="form-control input-lg" type="text" id="name" name="name" placeholder="Nombre del anuncio" value="{{Input::old('name')}}">
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-xs-6">
	                                        ...
	                                        <select class="js-select2 form-control" id="space" name="space" style="width: 100%;" data-placeholder="Seleciona un espacio...">
	                                            ...
	                                            @foreach($spaces as $c)
													<option value="{{$c->uid}}"{{Input::old('space') == $c->uid ? ' selected' : ''}}{{$c->taken() ? ' disabled' : ''}}>{{$c->description}}</option>
												@endforeach
	                                        </select>
										</div>
									</div>
